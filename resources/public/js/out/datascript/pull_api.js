...
return cljs.core.assoc.call(null,frame,new cljs.core.Keyword(null,"eids","eids",1546550700),eids,new cljs.core.Keyword(null,"specs","specs",1426570741),cljs.core.seq.call(null,new cljs.core.Keyword(null,"attrs","attrs",-2090668713).cljs$core$IFn$_invoke$arity$1(pattern)),new cljs.core.Keyword(null,"wildcard?","wildcard?",-686044101),new cljs.core.Keyword(null,"wildcard?","wildcard?",-686044101).cljs$core$IFn$_invoke$arity$1(pattern),new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.transient$.call(null,cljs.core.PersistentArrayMap.EMPTY),new cljs.core.Keyword(null,"results","results",-1134170113),(function (){var G__40337 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq.call(null,kvps)){
return cljs.core.conj_BANG_.call(null,G__40337,kvps);
} else {
return G__40337;
}
})());
...
var depth = cljs.core.get.call(null,map__40340__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.call(null,map__40340__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__40343 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__40343__$1 = (((G__40343 == null))?null:cljs.core.persistent_BANG_.call(null,G__40343));
if((G__40343__$1 == null)){
return null;
} else {
return cljs.core.get.call(null,G__40343__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__40344){
var vec__40349 = p__40344;
var seq__40350 = cljs.core.seq.call(null,vec__40349);
var first__40351 = cljs.core.first.call(null,seq__40350);
var seq__40350__$1 = cljs.core.next.call(null,seq__40350);
var frame = first__40351;
var frames = seq__40350__$1;
...
var results = (function (){var G__40352 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq.call(null,kvps)){
return cljs.core.conj_BANG_.call(null,G__40352,kvps);
} else {
return G__40352;
}
})();
...
var recursion = cljs.core.get.call(null,map__40355__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.call(null,map__40355__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_40357 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
datascript.pull_api.expand_frame = ((function (pattern_40357){
...
return cljs.core.assoc.call(null,datascript.pull_api.subpattern_frame.call(null,pattern_40357,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});})(pattern_40357))
;
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__40359){
var vec__40367 = p__40359;
var seq__40368 = cljs.core.seq.call(null,vec__40367);
var first__40369 = cljs.core.first.call(null,seq__40368);
var seq__40368__$1 = cljs.core.next.call(null,seq__40368);
var parent = first__40369;
var frames = seq__40368__$1;
...
var found = cljs.core.not_empty.call(null,(function (){var G__40370 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.take.call(null,limit),G__40370);
} else {
return G__40370;
}
})());
...
var datom_val = (cljs.core.truth_(forward_QMARK_)?((function (ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__40367,seq__40368,first__40369,seq__40368__$1,parent,frames){
return (function (d){
return d.v;
});})(ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__40367,seq__40368,first__40369,seq__40368__$1,parent,frames))
:((function (ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__40367,seq__40368,first__40369,seq__40368__$1,parent,frames){
return (function (d){
return d.e;
});})(ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__40367,seq__40368,first__40369,seq__40368__$1,parent,frames))
);
...
var as_value = (function (){var G__40371 = datom_val;
if(ref_QMARK_){
return cljs.core.comp.call(null,((function (G__40371,ref_QMARK_,component_QMARK_,multi_QMARK_,datom_val,limit,found,vec__40367,seq__40368,first__40369,seq__40368__$1,parent,frames){
return (function (p1__40358_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__40358_SHARP_]);
});})(G__40371,ref_QMARK_,component_QMARK_,multi_QMARK_,datom_val,limit,found,vec__40367,seq__40368,first__40369,seq__40368__$1,parent,frames))
,G__40371);
} else {
return G__40371;
}
...
return cljs.core.conj.call(null,frames,cljs.core.update.call(null,parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key,(function (){var G__40372 = cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,as_value),found);
if(single_QMARK_){
return cljs.core.first.call(null,G__40372);
} else {
return G__40372;
}
})()));
...
return cljs.core.conj.call(null,frames,(function (){var G__40373 = parent;
if(cljs.core.contains_QMARK_.call(null,opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.call(null,G__40373,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__40373;
}
})());
...
var vec__40377 = spec;
var attr_key = cljs.core.nth.call(null,vec__40377,(0),null);
var opts = cljs.core.nth.call(null,vec__40377,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.call(null,(function (p__40380){
var vec__40381 = p__40380;
var k = cljs.core.nth.call(null,vec__40381,(0),null);
var v = cljs.core.nth.call(null,vec__40381,(1),null);
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__40384){
var vec__40388 = p__40384;
var seq__40389 = cljs.core.seq.call(null,vec__40388);
var first__40390 = cljs.core.first.call(null,seq__40389);
var seq__40389__$1 = cljs.core.next.call(null,seq__40389);
var frame = first__40390;
var frames = seq__40389__$1;
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__40391){
var vec__40398 = p__40391;
...
var frame = first__40400;
var frames = seq__40399__$1;
...
var vec__40401 = cljs.core.first.call(null,datoms_by_attr);
var attr = cljs.core.nth.call(null,vec__40401,(0),null);
var datoms = cljs.core.nth.call(null,vec__40401,(1),null);
...
var attr = cljs.core.get.call(null,map__40407__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.call(null,map__40407__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__40409 = recursion;
if(!((attr == null))){
return datascript.pull_api.push_recursion.call(null,G__40409,attr,eid);
} else {
return G__40409;
}
})();
...
var map__40412 = frame;
var map__40412__$1 = ((((!((map__40412 == null)))?((((map__40412.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__40412.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__40412):map__40412);
var eid = cljs.core.get.call(null,map__40412__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.call(null,map__40412__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__40414){
while(true){
var vec__40418 = p__40414;
...
var frame = first__40420;
var frames = seq__40419__$1;
var temp__6751__auto__ = cljs.core.seq.call(null,new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__6751__auto__){
var eids = temp__6751__auto__;
...
var G__40421 = db;
var G__40422 = cljs.core.conj.call(null,frames,datascript.pull_api.reset_frame.call(null,frame,cljs.core.rest.call(null,eids),cljs.core.not_empty.call(null,cljs.core.persistent_BANG_.call(null,new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__40421;
p__40414 = G__40422;
continue;
}
...
while(true){
var G__40429 = (((new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first.call(null,frames)) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first.call(null,frames)).fqn:null);
switch (G__40429) {
case "expand":
var G__40436 = db;
var G__40437 = datascript.pull_api.pull_expand_frame.call(null,db,frames);
db = G__40436;
frames = G__40437;
continue;
...
case "expand-rev":
var G__40438 = db;
var G__40439 = datascript.pull_api.pull_expand_reverse_frame.call(null,db,frames);
db = G__40438;
frames = G__40439;
continue;
...
case "pattern":
var G__40440 = db;
var G__40441 = datascript.pull_api.pull_pattern_frame.call(null,db,frames);
db = G__40440;
frames = G__40441;
continue;
...
case "recursion":
var G__40442 = db;
var G__40443 = datascript.pull_api.pull_recursion_frame.call(null,db,frames);
db = G__40442;
frames = G__40443;
continue;
...
break;
case "done":
var vec__40430 = frames;
var seq__40431 = cljs.core.seq.call(null,vec__40430);
var first__40432 = cljs.core.first.call(null,seq__40431);
var seq__40431__$1 = cljs.core.next.call(null,seq__40431);
var f = first__40432;
var remaining = seq__40431__$1;
var result = (function (){var G__40433 = cljs.core.persistent_BANG_.call(null,new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not.call(null,new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first.call(null,G__40433);
} else {
return G__40433;
}
})();
...
var G__40444 = db;
var G__40445 = cljs.core.conj.call(null,cljs.core.rest.call(null,remaining),(function (){var G__40434 = cljs.core.first.call(null,remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.call(null,G__40434,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__40434;
}
})());
...
var eids__$1 = cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,(function (p1__40446_SHARP_){
return datascript.db.entid_strict.call(null,db,p1__40446_SHARP_);
})),eids);
...
//# sourceMappingURL=pull_api.js.map?rel=1509941610070